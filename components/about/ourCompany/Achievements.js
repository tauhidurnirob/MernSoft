        ...
        <div className='flex flex-col md:flex-row'>
          <div className='flex-auto md:flex-1 md:my-auto mt-14 mr-0 lg:mr-10'>
            ...
            <p className='text-paragraphColor font-bold py-5'>
              ...
              impedit magni provident. Quidem deleniti omnis pariatur debitis
              nemo ut praesentium. Lorem, ipsum dolor sit amet consectetur
              adipisicing elit. Nostrum impedit magni provident. Quidem deleniti
              omnis pariatur debitis nemo ut praesentium.
            </p>
          </div>
