...
import logo from '../public/mernSoftLogo.svg'
import peopleIcon from '../public/navIcon/people.png'
import workspaceIcon from '../public/navIcon/workspace.png'
import personalGrowthIcon from '../public/navIcon/personalGrowth.png'
                                ...
                                <ul className='absolute top-15 left-0 bg-white w-full px-5 pb-10 z-50 overflow-hidden'>
                                    <Link href='#'>
                                        <a className='dropdown flex justify-between hover:text-primary px-3 py-2 text-base'>
                                            About
                                            <ChevronDownIcon className='dropdown-arrow lg:w-7 lg:h-7 w-6 h-6 text-primary' />
