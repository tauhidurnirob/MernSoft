      ...
      <div className='custom-container '>
        <div className='flex flex-col md:flex-row py-10'>
          ...
          <div className='flex-1'>
            <div className='flex'>
              <div className='flex-1 my-5'>
                <h1 className='text-xl text-white font-bold'>Industries</h1>
                <div className='flex flex-col text-white opacity-50 links mt-5'>
                  <a className='my-2' href='#'>
                    Government Apps
                  </a>
              ...
              <div className='flex-1 my-5'>
                <h1 className='text-xl text-white font-bold'>Portfolio</h1>
                <div className='flex flex-col text-white opacity-50 links mt-5'>
                  <a className='my-2' href='#'>
                    Helix-d
                  </a>
        ...
        <div className='flex flex-col md:flex-row justify-center md:justify-end'>
          ...
          <div className='social-icon flex w-28'>
            <a href='#'>
              <img src='/socialIcons/facebook.png' alt='img' />
            </a>
            <a href='#'>
              <img src='/socialIcons/twitter.png' alt='img' />
            </a>
            <a href='#'>
              <img src='/socialIcons/instagram.png' alt='img' />
            </a>
            <a href='#'>
              <img src='/socialIcons/linkedin.png' alt='img' />
            </a>
          </div>
        </div>
      </div>
